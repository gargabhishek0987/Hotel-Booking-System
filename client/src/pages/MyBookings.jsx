  ...
  return (
      ...
      <div className='max-w-6xl mt-8 w-full text-gray-800'>
        ...
        {bookings.map((booking) => (
          <div key={booking.id} className='grid grid-cols-[3fr_2fr_1fr] w-full py-4 border-b border-gray-300'>
            ...
            <div className='flex  flex-col md:flex-row'>
              ...
              <div className='flex flex-col gap-1.5 max-md:mt-3 min-md:ml-4'>
                ...
                <span className='font-inter txt-sm'> ({booking.room.roomType})</span>
                </p>
            ...
            <div className='flex flex-col items-start justify-center pt-3'>
              ...
              {!booking.isPaid && (
                <button className='px-4 py-1.5 mt-4 text-xs border botder-gray-400 rounded-full hover:bg-gray-50 transition-all cursor-pointer'>
                  Pay Now
                </button>)}
              </div>
            </div>
