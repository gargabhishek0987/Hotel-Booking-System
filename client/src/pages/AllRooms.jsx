  ...
  return (
    <div className='flex flex-col-reverse lg:flex-row items-start justify-between pt-28 md:pt-28 px-4 md:px-16 lg:px-24 xl:px-32'>
              ...
              {roomsDummyData.map((room) => (
                  <div className='flex flex-col md:flex-row items-start py-10 gap-6 border-b border-gray-300 last:pb-30 last:border-0' key={room._id}>
                      ...
                      <div className='md:w-1/2 flex flex-col gap-2'>
                          ...
                          <p className='tetx-x1 font-medium text-gray-700'>${room.pricePerNight} /night</p>
                 </div>
                  </div>
              ))}
          </div>
          ...
          <div className='bg-white w-80 border border-gray-300 text-gray-600 max-lg:mb-8 min-lg:mt-16'>
              ...
              <div className={`flex items-center justify-between px-5 py-2.5 border-b border-gray-300 ${openFilters && "border-b"}`}>
